...
I don't remember anything about this build, it certainly has bugs and seems to be a bit slow at times, so could either be running with my C engine, or my hardcore MIPS asm engine but still struggling with everything going on.  One thing I do know is that later in the project the load was super quick, and it isn't here, so it could be quite early. Really don't remember though!
